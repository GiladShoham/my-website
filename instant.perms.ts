...
//   - contact_me: no client access at all. Submissions are written server-side
//     by the submitContactForm server action using the admin token (which
//     bypasses these rules), so the public client never needs insert access.
//
