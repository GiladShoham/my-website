...
// Brand icons (GitHub, LinkedIn) were removed from lucide-react v1, so they are
// inlined here as SVGs, consistent with the X (Twitter) icon below.
const GithubIcon = () => (
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center space-y-8">
          <div className="flex space-x-6">
            {[
              { icon: <GithubIcon />, href: 'https://github.com/GiladShoham', label: 'GitHub' },
              { icon: <LinkedinIcon />, href: 'https://www.linkedin.com/in/shohamgilad/', label: 'LinkedIn' },
